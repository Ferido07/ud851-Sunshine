    ...
    public class WeatherQueryTask extends AsyncTask<URL,Void,String[]>{
        ...
        protected String[] doInBackground(URL... params) {
            ...
            try {
                ...
                String[] parsedWeatherStrings = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonWeatherResponse);
                return parsedWeatherStrings;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        @Override
        protected void onPostExecute(String[] parsedWeatherStrings) {
            if (parsedWeatherStrings == null)
                return;
            for(String parsedWetherString : parsedWeatherStrings){
                mWeatherTextView.append(parsedWetherString +"\n\n\n");
            }
        }
    }
